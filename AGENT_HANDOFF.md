...
- **2026-08-03**: Cleaned up visual clutter in `/onboarding` wizard — removed redundant internal horizontal divider lines under the progress bar, above the footer, and above step navigation actions for a sleek, borderless frosted glass layout. Verified zero TypeScript errors (`npx tsc --noEmit`) and pushed to main.
