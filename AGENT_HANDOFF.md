...
- **2026-08-03**: Redesigned onboarding header with modern aesthetic — added glowing active step pill indicator (`Step 1 of 7` with pulse dot), sleek uppercase merchant badge, and replaced choppy segmented bars with a continuous smooth progress track featuring fluid width animation and white ambient glow. Verified zero TypeScript errors (`npx tsc --noEmit`) and pushed to main.
