...
- **2026-08-03**: Updated `/onboarding` channel connection buttons (`Facebook Messenger`, `Instagram DMs`, `WhatsApp`) to open in a new browser tab (`target="_blank" rel="noopener noreferrer"`), increased card glass transparency (`bg-[rgba(10,12,20,0.60)] backdrop-blur-[24px]`), and removed all hard gradient fade overlays across all step pages. Verified zero TypeScript errors (`npx tsc --noEmit`) and pushed to main.
