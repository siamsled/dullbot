...
- **2026-08-03**: Restricted `/login` authentication exclusively to **Google OAuth** — removed legacy email/password form inputs, dividers, and password handling. Users now sign in or create accounts seamlessly via Google OAuth. Verified zero TypeScript errors (`npx tsc --noEmit`) and pushed to main.
