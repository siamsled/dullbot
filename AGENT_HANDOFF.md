...
- **2026-08-03**: Fixed `/login` card shape & aspect ratio — widened max width (`max-w-[450px]`), increased card padding (`44px 40px 36px`), and adjusted vertical spacing for inputs (`padding: 12px 16px`) and buttons (`13px`) for a balanced, modern modal shape. Verified zero TypeScript errors (`npx tsc --noEmit`) and pushed to main.
