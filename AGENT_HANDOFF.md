...
- **2026-08-03**: Updated `/login` card shape to 1:1 square aspect ratio — increased max width to `490px` and set padding to `44px 44px 38px` for a balanced square frosted glass modal. Verified zero TypeScript errors (`npx tsc --noEmit`) and pushed to main.
