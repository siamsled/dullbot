  ...
  return (
    <div className="flex flex-col w-full bg-white border-t border-[#E5E5E5]">
      ...
      <div className="flex-1 relative flex items-center">
        {isRecording ? (
          <div className="w-full bg-[#F0F2F5] h-[36px] rounded-full flex items-center justify-between px-4">
          ...
          <>
            <input
              ...
              className="w-full bg-[#F0F2F5] rounded-full pl-4 pr-10 h-[36px] text-[15px] text-[#050505] placeholder:text-[#65676B] focus:outline-none"
            />
            <button 
              type="button"
              onClick={handleEmoji}
              disabled={disabled}
              className="absolute right-2 p-1 text-[#0084FF] rounded-full hover:bg-black/5 transition-colors disabled:opacity-50"
            >
