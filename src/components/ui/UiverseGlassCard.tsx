...
export default function UiverseGlassCard({
  ...
  const variantClasses = {
    ...
    warm: 'bg-apricot-wash/90 backdrop-blur-md border border-rust/15 shadow-[0_8px_30px_rgba(93,42,26,0.08)] text-ink',
    cool: 'bg-sky-wash/90 backdrop-blur-md border border-blue-200/50 shadow-[0_8px_30px_rgba(59,130,246,0.08)] text-ink',
    dark: 'bg-white/90 backdrop-blur-md border border-dove/15 shadow-[0_8px_30px_rgb(0,0,0,0.04)] text-ink',
  };
