    ...
    <div className="sw-root">
      ...
      <style>{`
        ...
        @keyframes radarExpand {
          0%   { width: 0; height: 0; opacity: 0.8; border-color: rgba(255,255,255,0.5); }
          100% { width: 260px; height: 260px; opacity: 0; border-color: rgba(255,255,255,0); }
        }
        .sw-radar-dot {
        ...
        @keyframes dotPulse2 {
          0%, 100% { transform: scale(1); box-shadow: 0 0 20px 6px rgba(255,255,255,0.4); }
          50% { transform: scale(0.7); box-shadow: 0 0 10px 3px rgba(255,255,255,0.2); }
        }
        .sw-content {
          position: relative; z-index: 2;
        ...
        .sw-body span { font-size: 0.85em; color: rgba(255,255,255,0.4); }
        .sw-btn {
