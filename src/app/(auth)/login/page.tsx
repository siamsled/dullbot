  ...
  return (
    <UiverseGridBackground variant="grid">
      <div className="min-h-screen flex items-center justify-center p-4">
        <ShineBorder shineColor={["#A07CFE", "#FE8FB5", "#FFBE7B"]} className="w-full max-w-[360px] p-0">
          <Card className="relative w-full border-0 shadow-xl bg-white/95 backdrop-blur-md">
