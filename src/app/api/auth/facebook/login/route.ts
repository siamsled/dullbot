...
export async function GET(request: Request) {
  ...
  // Request all permissions for Facebook Messenger, FB post comments/private replies, Instagram DMs, Instagram comments, Business Manager & WhatsApp Cloud API
  const scopes = 'pages_show_list,pages_messaging,pages_manage_metadata,pages_read_engagement,pages_manage_posts,instagram_basic,instagram_manage_messages,instagram_manage_comments,business_management,whatsapp_business_messaging,whatsapp_business_management';
